...
<%
	List<Product> products = (List<Product>) request.getAttribute("dsNguCoc");
	NumberFormat numberFormat = NumberFormat.getCurrencyInstance();
%>
<body>
	<div class="col-md-4" id="product-slider-5">
		...
		<div class="see-more">
			<a href="san-pham?action=filter&page=1&category=8" class="">Xem tất cả</a>
		</div>
	</div>
</body>
</html>